...
$res = $pdo->query("SELECT title, description, postal_code, city, type, price FROM advert ORDER BY id DESC LIMIT 15");
...
<h1 class="text-center"> Voici nos 15 derniers biens </h1>
